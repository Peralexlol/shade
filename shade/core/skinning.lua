...
function Shade:SkinFrame(frame, config)
    ...
    frame:SetBackdropBorderColor(unpack(Shade.Colors.Accent))
end
...
function Shade:SkinActionButton(button, config)
    ...
    button.shadeSkin:SetBackdropBorderColor(
        Shade.Colors.Accent[1], 
        Shade.Colors.Accent[2], 
        Shade.Colors.Accent[3], 
        config.gloss
    )
